...
gulp.task("predev", gulp.series("sheetToKV", "kvToJS", "img_pcache"));
// gulp.task("predev", gulp.series("sheetToKV", "kvToJS", "csvToLocalization", "img_pcache"));
gulp.task("dev", gulp.parallel("sheetToKV:watch", "img_pcache:watch"));
...
// 编译发布版本
gulp.task("prod", gulp.series("sheetToKV", "kvToJS", "img_pcache"));
