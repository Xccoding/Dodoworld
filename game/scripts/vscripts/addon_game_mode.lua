...
function DodoWorld:InitGameMode()
	...
	require('common.managers.AbilityCharge_manager')
	...
	CustomGameEventManager:RegisterListener("SelectTalent", function (context, params)
		TablePrint(params)
		local hero = PlayerResource:GetSelectedHeroEntity(params.PlayerID)
		if hero ~= nil and hero.Talent_manager ~= nil then
			hero.Talent_manager:SelectTalent(params.talent_name)
		end
	end)
