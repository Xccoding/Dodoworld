...
function modifier_death_knight_mortal_strike:OnCreated(params)
    ...
    self.nova_free_chance = self:GetAbilitySpecialValueFor("nova_free_chance")
    self.nova_free_duration = self:GetAbilitySpecialValueFor("nova_free_duration")
    self.bulldoze_stack = self:GetAbilitySpecialValueFor("bulldoze_stack")
